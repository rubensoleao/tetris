...
def getTetrisSprites():
    ...
    piece_sprite[2] = np.array([[0, 1, 1], [1, 1, 0]])

    piece_sprite[3] = np.array([[1, 1], [1, 1]])

    piece_sprite[4] = np.array([[1, 0], [1, 0], [1, 1]])

    piece_sprite[5] = np.array([[0, 1], [0, 1], [1, 1]])

    piece_sprite[6] = np.array([[1], [1], [1], [1]])
